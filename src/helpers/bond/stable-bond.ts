...
export class StableBond extends Bond {
    ...
    public async getBalanceOf(networkID: Networks, wraithContract: Contract) {
        const balance = (await wraithContract.balanceOf(super.getAddressForBond(networkID))) / Math.pow(10, 9);
        return balance;
    }
}
